-- Migration: Fix trigger for stock adjustments to update inventory
-- Description: Recreates the trigger with proper SET options to ensure it fires correctly
-- Date: Fix trigger for stock adjustments
...
PRINT 'Trigger TR_tbl_stock_adjustments_UpdateInventory recreated successfully.';
GO
